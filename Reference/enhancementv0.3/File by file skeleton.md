...
## Below is the same skeleton, split file-by-file in a cleaner production-style layout.  
##   
...
export interface IBridgeClient {
  sendEvent(event: WidgetEventEnvelope): Promise<BridgeResponse>;
...
**src/panels/right/ActionBar.tsx**  
...
**src/workspaces/review/ReviewWorkspace.tsx**  
